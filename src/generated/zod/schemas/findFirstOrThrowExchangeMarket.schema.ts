...
export const ExchangeMarketFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ExchangeMarketSelect> = z.object({
...
export const ExchangeMarketFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    exchangeId: z.boolean().optional(),
    exchange: z.boolean().optional(),
    code: z.boolean().optional(),
