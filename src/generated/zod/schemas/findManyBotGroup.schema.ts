...
export const BotGroupFindManySelectSchema: z.ZodType<Prisma.BotGroupSelect> = z.object({
...
export const BotGroupFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    botId: z.boolean().optional(),
    bot: z.boolean().optional(),
    key: z.boolean().optional(),
...
export const BotGroupFindManySchema: z.ZodType<Prisma.BotGroupFindManyArgs> = z.object({ select: BotGroupFindManySelectSchema.optional(), include: z.lazy(() => BotGroupIncludeObjectSchema.optional()), orderBy: z.union([BotGroupOrderByWithRelationInputObjectSchema, BotGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotGroupWhereInputObjectSchema.optional(), cursor: BotGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotGroupScalarFieldEnumSchema, BotGroupScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BotGroupFindManyArgs>;

export const BotGroupFindManyZodSchema = z.object({ select: BotGroupFindManySelectSchema.optional(), include: z.lazy(() => BotGroupIncludeObjectSchema.optional()), orderBy: z.union([BotGroupOrderByWithRelationInputObjectSchema, BotGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotGroupWhereInputObjectSchema.optional(), cursor: BotGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotGroupScalarFieldEnumSchema, BotGroupScalarFieldEnumSchema.array()]).optional() }).strict();