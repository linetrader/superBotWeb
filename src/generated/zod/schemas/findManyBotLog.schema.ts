...
export const BotLogFindManySelectSchema: z.ZodType<Prisma.BotLogSelect> = z.object({
...
export const BotLogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    botId: z.boolean().optional(),
    bot: z.boolean().optional(),
    level: z.boolean().optional(),
...
export const BotLogFindManySchema: z.ZodType<Prisma.BotLogFindManyArgs> = z.object({ select: BotLogFindManySelectSchema.optional(), include: z.lazy(() => BotLogIncludeObjectSchema.optional()), orderBy: z.union([BotLogOrderByWithRelationInputObjectSchema, BotLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotLogWhereInputObjectSchema.optional(), cursor: BotLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotLogScalarFieldEnumSchema, BotLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BotLogFindManyArgs>;

export const BotLogFindManyZodSchema = z.object({ select: BotLogFindManySelectSchema.optional(), include: z.lazy(() => BotLogIncludeObjectSchema.optional()), orderBy: z.union([BotLogOrderByWithRelationInputObjectSchema, BotLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotLogWhereInputObjectSchema.optional(), cursor: BotLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotLogScalarFieldEnumSchema, BotLogScalarFieldEnumSchema.array()]).optional() }).strict();