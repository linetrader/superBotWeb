...
export const CountryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CountrySelect> = z.object({
...
export const CountryFindFirstOrThrowSelectZodSchema = z.object({
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    users: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const CountryFindFirstOrThrowSchema: z.ZodType<Prisma.CountryFindFirstOrThrowArgs> = z.object({ select: CountryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CountryIncludeObjectSchema.optional()), orderBy: z.union([CountryOrderByWithRelationInputObjectSchema, CountryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CountryWhereInputObjectSchema.optional(), cursor: CountryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CountryScalarFieldEnumSchema, CountryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CountryFindFirstOrThrowArgs>;

export const CountryFindFirstOrThrowZodSchema = z.object({ select: CountryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CountryIncludeObjectSchema.optional()), orderBy: z.union([CountryOrderByWithRelationInputObjectSchema, CountryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CountryWhereInputObjectSchema.optional(), cursor: CountryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CountryScalarFieldEnumSchema, CountryScalarFieldEnumSchema.array()]).optional() }).strict();