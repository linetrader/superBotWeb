...
export const TradingBotFindFirstSelectSchema: z.ZodType<Prisma.TradingBotSelect> = z.object({
...
export const TradingBotFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    mode: z.boolean().optional(),
    exchangeMarketId: z.boolean().optional(),
...
export const TradingBotFindFirstSchema: z.ZodType<Prisma.TradingBotFindFirstArgs> = z.object({ select: TradingBotFindFirstSelectSchema.optional(), include: z.lazy(() => TradingBotIncludeObjectSchema.optional()), orderBy: z.union([TradingBotOrderByWithRelationInputObjectSchema, TradingBotOrderByWithRelationInputObjectSchema.array()]).optional(), where: TradingBotWhereInputObjectSchema.optional(), cursor: TradingBotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TradingBotScalarFieldEnumSchema, TradingBotScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TradingBotFindFirstArgs>;

export const TradingBotFindFirstZodSchema = z.object({ select: TradingBotFindFirstSelectSchema.optional(), include: z.lazy(() => TradingBotIncludeObjectSchema.optional()), orderBy: z.union([TradingBotOrderByWithRelationInputObjectSchema, TradingBotOrderByWithRelationInputObjectSchema.array()]).optional(), where: TradingBotWhereInputObjectSchema.optional(), cursor: TradingBotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TradingBotScalarFieldEnumSchema, TradingBotScalarFieldEnumSchema.array()]).optional() }).strict();