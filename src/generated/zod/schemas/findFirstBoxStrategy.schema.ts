...
export const BoxStrategyFindFirstSelectSchema: z.ZodType<Prisma.BoxStrategySelect> = z.object({
...
export const BoxStrategyFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    strategyConfigId: z.boolean().optional(),
    strategyConfig: z.boolean().optional(),
    lowerTh: z.boolean().optional(),
...
export const BoxStrategyFindFirstSchema: z.ZodType<Prisma.BoxStrategyFindFirstArgs> = z.object({ select: BoxStrategyFindFirstSelectSchema.optional(), include: z.lazy(() => BoxStrategyIncludeObjectSchema.optional()), orderBy: z.union([BoxStrategyOrderByWithRelationInputObjectSchema, BoxStrategyOrderByWithRelationInputObjectSchema.array()]).optional(), where: BoxStrategyWhereInputObjectSchema.optional(), cursor: BoxStrategyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BoxStrategyScalarFieldEnumSchema, BoxStrategyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BoxStrategyFindFirstArgs>;

export const BoxStrategyFindFirstZodSchema = z.object({ select: BoxStrategyFindFirstSelectSchema.optional(), include: z.lazy(() => BoxStrategyIncludeObjectSchema.optional()), orderBy: z.union([BoxStrategyOrderByWithRelationInputObjectSchema, BoxStrategyOrderByWithRelationInputObjectSchema.array()]).optional(), where: BoxStrategyWhereInputObjectSchema.optional(), cursor: BoxStrategyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BoxStrategyScalarFieldEnumSchema, BoxStrategyScalarFieldEnumSchema.array()]).optional() }).strict();