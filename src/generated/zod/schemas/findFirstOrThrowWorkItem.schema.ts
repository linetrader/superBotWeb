...
export const WorkItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.WorkItemSelect> = z.object({
...
export const WorkItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    botId: z.boolean().optional(),
    bot: z.boolean().optional(),
...
export const WorkItemFindFirstOrThrowSchema: z.ZodType<Prisma.WorkItemFindFirstOrThrowArgs> = z.object({ select: WorkItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => WorkItemIncludeObjectSchema.optional()), orderBy: z.union([WorkItemOrderByWithRelationInputObjectSchema, WorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkItemWhereInputObjectSchema.optional(), cursor: WorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkItemScalarFieldEnumSchema, WorkItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkItemFindFirstOrThrowArgs>;

export const WorkItemFindFirstOrThrowZodSchema = z.object({ select: WorkItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => WorkItemIncludeObjectSchema.optional()), orderBy: z.union([WorkItemOrderByWithRelationInputObjectSchema, WorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkItemWhereInputObjectSchema.optional(), cursor: WorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkItemScalarFieldEnumSchema, WorkItemScalarFieldEnumSchema.array()]).optional() }).strict();