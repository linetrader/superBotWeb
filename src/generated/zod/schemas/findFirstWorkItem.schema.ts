...
export const WorkItemFindFirstSelectSchema: z.ZodType<Prisma.WorkItemSelect> = z.object({
...
export const WorkItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    botId: z.boolean().optional(),
    bot: z.boolean().optional(),
...
export const WorkItemFindFirstSchema: z.ZodType<Prisma.WorkItemFindFirstArgs> = z.object({ select: WorkItemFindFirstSelectSchema.optional(), include: z.lazy(() => WorkItemIncludeObjectSchema.optional()), orderBy: z.union([WorkItemOrderByWithRelationInputObjectSchema, WorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkItemWhereInputObjectSchema.optional(), cursor: WorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkItemScalarFieldEnumSchema, WorkItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WorkItemFindFirstArgs>;

export const WorkItemFindFirstZodSchema = z.object({ select: WorkItemFindFirstSelectSchema.optional(), include: z.lazy(() => WorkItemIncludeObjectSchema.optional()), orderBy: z.union([WorkItemOrderByWithRelationInputObjectSchema, WorkItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: WorkItemWhereInputObjectSchema.optional(), cursor: WorkItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WorkItemScalarFieldEnumSchema, WorkItemScalarFieldEnumSchema.array()]).optional() }).strict();