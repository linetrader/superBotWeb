...
export const BotGroupExchangeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BotGroupExchangeSelect> = z.object({
...
export const BotGroupExchangeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    groupId: z.boolean().optional(),
    group: z.boolean().optional(),
    exchangeMarketId: z.boolean().optional(),
...
export const BotGroupExchangeFindFirstOrThrowSchema: z.ZodType<Prisma.BotGroupExchangeFindFirstOrThrowArgs> = z.object({ select: BotGroupExchangeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BotGroupExchangeIncludeObjectSchema.optional()), orderBy: z.union([BotGroupExchangeOrderByWithRelationInputObjectSchema, BotGroupExchangeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotGroupExchangeWhereInputObjectSchema.optional(), cursor: BotGroupExchangeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotGroupExchangeScalarFieldEnumSchema, BotGroupExchangeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BotGroupExchangeFindFirstOrThrowArgs>;

export const BotGroupExchangeFindFirstOrThrowZodSchema = z.object({ select: BotGroupExchangeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BotGroupExchangeIncludeObjectSchema.optional()), orderBy: z.union([BotGroupExchangeOrderByWithRelationInputObjectSchema, BotGroupExchangeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotGroupExchangeWhereInputObjectSchema.optional(), cursor: BotGroupExchangeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotGroupExchangeScalarFieldEnumSchema, BotGroupExchangeScalarFieldEnumSchema.array()]).optional() }).strict();