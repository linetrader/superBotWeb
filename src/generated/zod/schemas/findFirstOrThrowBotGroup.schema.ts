...
export const BotGroupFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BotGroupSelect> = z.object({
...
export const BotGroupFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    botId: z.boolean().optional(),
    bot: z.boolean().optional(),
    key: z.boolean().optional(),
...
export const BotGroupFindFirstOrThrowSchema: z.ZodType<Prisma.BotGroupFindFirstOrThrowArgs> = z.object({ select: BotGroupFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BotGroupIncludeObjectSchema.optional()), orderBy: z.union([BotGroupOrderByWithRelationInputObjectSchema, BotGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotGroupWhereInputObjectSchema.optional(), cursor: BotGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotGroupScalarFieldEnumSchema, BotGroupScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BotGroupFindFirstOrThrowArgs>;

export const BotGroupFindFirstOrThrowZodSchema = z.object({ select: BotGroupFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BotGroupIncludeObjectSchema.optional()), orderBy: z.union([BotGroupOrderByWithRelationInputObjectSchema, BotGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotGroupWhereInputObjectSchema.optional(), cursor: BotGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotGroupScalarFieldEnumSchema, BotGroupScalarFieldEnumSchema.array()]).optional() }).strict();