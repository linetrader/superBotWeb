...
export const ExchangeCredentialFindFirstSelectSchema: z.ZodType<Prisma.ExchangeCredentialSelect> = z.object({
...
export const ExchangeCredentialFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    exchangeId: z.boolean().optional(),
...
export const ExchangeCredentialFindFirstSchema: z.ZodType<Prisma.ExchangeCredentialFindFirstArgs> = z.object({ select: ExchangeCredentialFindFirstSelectSchema.optional(), include: z.lazy(() => ExchangeCredentialIncludeObjectSchema.optional()), orderBy: z.union([ExchangeCredentialOrderByWithRelationInputObjectSchema, ExchangeCredentialOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExchangeCredentialWhereInputObjectSchema.optional(), cursor: ExchangeCredentialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExchangeCredentialScalarFieldEnumSchema, ExchangeCredentialScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ExchangeCredentialFindFirstArgs>;

export const ExchangeCredentialFindFirstZodSchema = z.object({ select: ExchangeCredentialFindFirstSelectSchema.optional(), include: z.lazy(() => ExchangeCredentialIncludeObjectSchema.optional()), orderBy: z.union([ExchangeCredentialOrderByWithRelationInputObjectSchema, ExchangeCredentialOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExchangeCredentialWhereInputObjectSchema.optional(), cursor: ExchangeCredentialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExchangeCredentialScalarFieldEnumSchema, ExchangeCredentialScalarFieldEnumSchema.array()]).optional() }).strict();