...
export const ReferralEdgeFindFirstSelectSchema: z.ZodType<Prisma.ReferralEdgeSelect> = z.object({
...
export const ReferralEdgeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    parentId: z.boolean().optional(),
    parent: z.boolean().optional(),
...
export const ReferralEdgeFindFirstSchema: z.ZodType<Prisma.ReferralEdgeFindFirstArgs> = z.object({ select: ReferralEdgeFindFirstSelectSchema.optional(), include: z.lazy(() => ReferralEdgeIncludeObjectSchema.optional()), orderBy: z.union([ReferralEdgeOrderByWithRelationInputObjectSchema, ReferralEdgeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReferralEdgeWhereInputObjectSchema.optional(), cursor: ReferralEdgeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReferralEdgeScalarFieldEnumSchema, ReferralEdgeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ReferralEdgeFindFirstArgs>;

export const ReferralEdgeFindFirstZodSchema = z.object({ select: ReferralEdgeFindFirstSelectSchema.optional(), include: z.lazy(() => ReferralEdgeIncludeObjectSchema.optional()), orderBy: z.union([ReferralEdgeOrderByWithRelationInputObjectSchema, ReferralEdgeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ReferralEdgeWhereInputObjectSchema.optional(), cursor: ReferralEdgeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ReferralEdgeScalarFieldEnumSchema, ReferralEdgeScalarFieldEnumSchema.array()]).optional() }).strict();