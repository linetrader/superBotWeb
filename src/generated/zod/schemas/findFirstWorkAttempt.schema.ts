...
export const WorkAttemptFindFirstSelectSchema: z.ZodType<Prisma.WorkAttemptSelect> = z.object({
...
export const WorkAttemptFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    workItemId: z.boolean().optional(),
    workItem: z.boolean().optional(),
    startedAt: z.boolean().optional(),
