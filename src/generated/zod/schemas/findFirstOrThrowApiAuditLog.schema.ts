...
export const ApiAuditLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ApiAuditLogSelect> = z.object({
...
export const ApiAuditLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    path: z.boolean().optional(),
    method: z.boolean().optional(),
...
export const ApiAuditLogFindFirstOrThrowSchema: z.ZodType<Prisma.ApiAuditLogFindFirstOrThrowArgs> = z.object({ select: ApiAuditLogFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ApiAuditLogOrderByWithRelationInputObjectSchema, ApiAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApiAuditLogWhereInputObjectSchema.optional(), cursor: ApiAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApiAuditLogScalarFieldEnumSchema, ApiAuditLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ApiAuditLogFindFirstOrThrowArgs>;

export const ApiAuditLogFindFirstOrThrowZodSchema = z.object({ select: ApiAuditLogFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ApiAuditLogOrderByWithRelationInputObjectSchema, ApiAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApiAuditLogWhereInputObjectSchema.optional(), cursor: ApiAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApiAuditLogScalarFieldEnumSchema, ApiAuditLogScalarFieldEnumSchema.array()]).optional() }).strict();