...
export const UserInfoFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UserInfoSelect> = z.object({
...
export const UserInfoFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    referralCode: z.boolean().optional(),
