...
export const TradingBotFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TradingBotSelect> = z.object({
...
export const TradingBotFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    mode: z.boolean().optional(),
    exchangeMarketId: z.boolean().optional(),
...
export const TradingBotFindFirstOrThrowSchema: z.ZodType<Prisma.TradingBotFindFirstOrThrowArgs> = z.object({ select: TradingBotFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TradingBotIncludeObjectSchema.optional()), orderBy: z.union([TradingBotOrderByWithRelationInputObjectSchema, TradingBotOrderByWithRelationInputObjectSchema.array()]).optional(), where: TradingBotWhereInputObjectSchema.optional(), cursor: TradingBotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TradingBotScalarFieldEnumSchema, TradingBotScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TradingBotFindFirstOrThrowArgs>;

export const TradingBotFindFirstOrThrowZodSchema = z.object({ select: TradingBotFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TradingBotIncludeObjectSchema.optional()), orderBy: z.union([TradingBotOrderByWithRelationInputObjectSchema, TradingBotOrderByWithRelationInputObjectSchema.array()]).optional(), where: TradingBotWhereInputObjectSchema.optional(), cursor: TradingBotWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TradingBotScalarFieldEnumSchema, TradingBotScalarFieldEnumSchema.array()]).optional() }).strict();