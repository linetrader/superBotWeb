...
export const ExchangeFindManySelectSchema: z.ZodType<Prisma.ExchangeSelect> = z.object({
...
export const ExchangeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    active: z.boolean().optional(),
...
export const ExchangeFindManySchema: z.ZodType<Prisma.ExchangeFindManyArgs> = z.object({ select: ExchangeFindManySelectSchema.optional(), include: z.lazy(() => ExchangeIncludeObjectSchema.optional()), orderBy: z.union([ExchangeOrderByWithRelationInputObjectSchema, ExchangeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExchangeWhereInputObjectSchema.optional(), cursor: ExchangeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExchangeScalarFieldEnumSchema, ExchangeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ExchangeFindManyArgs>;

export const ExchangeFindManyZodSchema = z.object({ select: ExchangeFindManySelectSchema.optional(), include: z.lazy(() => ExchangeIncludeObjectSchema.optional()), orderBy: z.union([ExchangeOrderByWithRelationInputObjectSchema, ExchangeOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExchangeWhereInputObjectSchema.optional(), cursor: ExchangeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExchangeScalarFieldEnumSchema, ExchangeScalarFieldEnumSchema.array()]).optional() }).strict();