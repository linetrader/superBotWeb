...
export const ExchangeCredentialFindManySelectSchema: z.ZodType<Prisma.ExchangeCredentialSelect> = z.object({
...
export const ExchangeCredentialFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    exchangeId: z.boolean().optional(),
...
export const ExchangeCredentialFindManySchema: z.ZodType<Prisma.ExchangeCredentialFindManyArgs> = z.object({ select: ExchangeCredentialFindManySelectSchema.optional(), include: z.lazy(() => ExchangeCredentialIncludeObjectSchema.optional()), orderBy: z.union([ExchangeCredentialOrderByWithRelationInputObjectSchema, ExchangeCredentialOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExchangeCredentialWhereInputObjectSchema.optional(), cursor: ExchangeCredentialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExchangeCredentialScalarFieldEnumSchema, ExchangeCredentialScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ExchangeCredentialFindManyArgs>;

export const ExchangeCredentialFindManyZodSchema = z.object({ select: ExchangeCredentialFindManySelectSchema.optional(), include: z.lazy(() => ExchangeCredentialIncludeObjectSchema.optional()), orderBy: z.union([ExchangeCredentialOrderByWithRelationInputObjectSchema, ExchangeCredentialOrderByWithRelationInputObjectSchema.array()]).optional(), where: ExchangeCredentialWhereInputObjectSchema.optional(), cursor: ExchangeCredentialWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ExchangeCredentialScalarFieldEnumSchema, ExchangeCredentialScalarFieldEnumSchema.array()]).optional() }).strict();