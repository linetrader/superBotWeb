...
const makeSchema = () => z.object({
  ...
  referralCode: z.string().optional()
        ...
        const singles: string[] = ["id","userId","referralCode"] as string[];
...
export const UserInfoWhereUniqueInputObjectSchema: z.ZodType<Prisma.UserInfoWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.UserInfoWhereUniqueInput>;
export const UserInfoWhereUniqueInputObjectZodSchema = makeSchema();
