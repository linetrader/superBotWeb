...
export const UserWalletUncheckedCreateNestedOneWithoutUserInputObjectSchema: z.ZodType<Prisma.UserWalletUncheckedCreateNestedOneWithoutUserInput> = makeSchema() as unknown as z.ZodType<Prisma.UserWalletUncheckedCreateNestedOneWithoutUserInput>;
export const UserWalletUncheckedCreateNestedOneWithoutUserInputObjectZodSchema = makeSchema();
