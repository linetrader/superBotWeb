...
const makeSchema = () => z.object({
  ...
  withdrawAddress: z.string().optional()
        ...
        const singles: string[] = ["id","userId","depositAddress","withdrawAddress"] as string[];
...
export const UserWalletWhereUniqueInputObjectSchema: z.ZodType<Prisma.UserWalletWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.UserWalletWhereUniqueInput>;
export const UserWalletWhereUniqueInputObjectZodSchema = makeSchema();
