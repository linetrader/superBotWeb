...
const makeSchema = () => z.object({
  ...
  runs: z.lazy(() => WorkAttemptCreateNestedManyWithoutWorkItemInputObjectSchema)
}).strict();
export const WorkItemCreateInputObjectSchema: z.ZodType<Prisma.WorkItemCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.WorkItemCreateInput>;
export const WorkItemCreateInputObjectZodSchema = makeSchema();
