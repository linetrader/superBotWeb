...
import { BotGroupBotIdKeyCompoundUniqueInputObjectSchema as BotGroupBotIdKeyCompoundUniqueInputObjectSchema } from './BotGroupBotIdKeyCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  botId_key: z.lazy(() => BotGroupBotIdKeyCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["botId","key"]] as string[][];
...
export const BotGroupWhereUniqueInputObjectSchema: z.ZodType<Prisma.BotGroupWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.BotGroupWhereUniqueInput>;
export const BotGroupWhereUniqueInputObjectZodSchema = makeSchema();
