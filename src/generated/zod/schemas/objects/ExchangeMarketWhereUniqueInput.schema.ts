...
import { ExchangeMarketExchangeIdCodeCompoundUniqueInputObjectSchema as ExchangeMarketExchangeIdCodeCompoundUniqueInputObjectSchema } from './ExchangeMarketExchangeIdCodeCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  exchangeId_code: z.lazy(() => ExchangeMarketExchangeIdCodeCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["exchangeId","code"]] as string[][];
...
export const ExchangeMarketWhereUniqueInputObjectSchema: z.ZodType<Prisma.ExchangeMarketWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.ExchangeMarketWhereUniqueInput>;
export const ExchangeMarketWhereUniqueInputObjectZodSchema = makeSchema();
