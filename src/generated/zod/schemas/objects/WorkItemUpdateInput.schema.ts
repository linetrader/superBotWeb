...
import { TradingBotUpdateOneWithoutWorkItemsNestedInputObjectSchema as TradingBotUpdateOneWithoutWorkItemsNestedInputObjectSchema } from './TradingBotUpdateOneWithoutWorkItemsNestedInput.schema';
import { WorkAttemptUpdateManyWithoutWorkItemNestedInputObjectSchema as WorkAttemptUpdateManyWithoutWorkItemNestedInputObjectSchema } from './WorkAttemptUpdateManyWithoutWorkItemNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  bot: z.lazy(() => TradingBotUpdateOneWithoutWorkItemsNestedInputObjectSchema).optional(),
  runs: z.lazy(() => WorkAttemptUpdateManyWithoutWorkItemNestedInputObjectSchema).optional()
}).strict();
export const WorkItemUpdateInputObjectSchema: z.ZodType<Prisma.WorkItemUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.WorkItemUpdateInput>;
export const WorkItemUpdateInputObjectZodSchema = makeSchema();
