...
const makeSchema = () => z.object({
  ...
  strategyConfigId: z.string().optional()
        ...
        const singles: string[] = ["id","strategyConfigId"] as string[];
...
export const TrendStrategyWhereUniqueInputObjectSchema: z.ZodType<Prisma.TrendStrategyWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.TrendStrategyWhereUniqueInput>;
export const TrendStrategyWhereUniqueInputObjectZodSchema = makeSchema();
