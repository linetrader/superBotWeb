...
import { BotGroupExchangeGroupIdExchangeMarketIdCompoundUniqueInputObjectSchema as BotGroupExchangeGroupIdExchangeMarketIdCompoundUniqueInputObjectSchema } from './BotGroupExchangeGroupIdExchangeMarketIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  groupId_exchangeMarketId: z.lazy(() => BotGroupExchangeGroupIdExchangeMarketIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["groupId","exchangeMarketId"]] as string[][];
...
export const BotGroupExchangeWhereUniqueInputObjectSchema: z.ZodType<Prisma.BotGroupExchangeWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.BotGroupExchangeWhereUniqueInput>;
export const BotGroupExchangeWhereUniqueInputObjectZodSchema = makeSchema();
