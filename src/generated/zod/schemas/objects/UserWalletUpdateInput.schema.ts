...
import { UserUpdateOneRequiredWithoutWalletNestedInputObjectSchema as UserUpdateOneRequiredWithoutWalletNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutWalletNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  user: z.lazy(() => UserUpdateOneRequiredWithoutWalletNestedInputObjectSchema).optional()
}).strict();
export const UserWalletUpdateInputObjectSchema: z.ZodType<Prisma.UserWalletUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.UserWalletUpdateInput>;
export const UserWalletUpdateInputObjectZodSchema = makeSchema();
