...
import { ExchangeCredentialUserIdExchangeIdCompoundUniqueInputObjectSchema as ExchangeCredentialUserIdExchangeIdCompoundUniqueInputObjectSchema } from './ExchangeCredentialUserIdExchangeIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  userId_exchangeId: z.lazy(() => ExchangeCredentialUserIdExchangeIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["userId","exchangeId"]] as string[][];
...
export const ExchangeCredentialWhereUniqueInputObjectSchema: z.ZodType<Prisma.ExchangeCredentialWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.ExchangeCredentialWhereUniqueInput>;
export const ExchangeCredentialWhereUniqueInputObjectZodSchema = makeSchema();
