...
const makeSchema = () => z.object({
  ...
  sqsMessageId: z.string().optional()
        ...
        const singles: string[] = ["id","dedupeKey","sqsMessageId"] as string[];
...
export const WorkItemWhereUniqueInputObjectSchema: z.ZodType<Prisma.WorkItemWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.WorkItemWhereUniqueInput>;
export const WorkItemWhereUniqueInputObjectZodSchema = makeSchema();
