...
import { WorkAttemptUncheckedUpdateManyWithoutWorkItemNestedInputObjectSchema as WorkAttemptUncheckedUpdateManyWithoutWorkItemNestedInputObjectSchema } from './WorkAttemptUncheckedUpdateManyWithoutWorkItemNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  botId: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  runs: z.lazy(() => WorkAttemptUncheckedUpdateManyWithoutWorkItemNestedInputObjectSchema).optional()
}).strict();
export const WorkItemUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.WorkItemUncheckedUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.WorkItemUncheckedUpdateInput>;
export const WorkItemUncheckedUpdateInputObjectZodSchema = makeSchema();
