...
import { StrategyConfigUserIdNameCompoundUniqueInputObjectSchema as StrategyConfigUserIdNameCompoundUniqueInputObjectSchema } from './StrategyConfigUserIdNameCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  userId_name: z.lazy(() => StrategyConfigUserIdNameCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["userId","name"]] as string[][];
...
export const StrategyConfigWhereUniqueInputObjectSchema: z.ZodType<Prisma.StrategyConfigWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.StrategyConfigWhereUniqueInput>;
export const StrategyConfigWhereUniqueInputObjectZodSchema = makeSchema();
