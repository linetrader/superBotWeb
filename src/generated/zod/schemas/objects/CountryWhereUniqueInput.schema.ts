...
const makeSchema = () => z.object({
  code: z.string().max(2).optional()
        ...
        const singles: string[] = ["code"] as string[];
...
export const CountryWhereUniqueInputObjectSchema: z.ZodType<Prisma.CountryWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.CountryWhereUniqueInput>;
export const CountryWhereUniqueInputObjectZodSchema = makeSchema();
