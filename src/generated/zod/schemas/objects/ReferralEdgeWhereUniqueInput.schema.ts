...
import { ReferralEdgeChildIdTypeCompoundUniqueInputObjectSchema as ReferralEdgeChildIdTypeCompoundUniqueInputObjectSchema } from './ReferralEdgeChildIdTypeCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.string().optional(),
  childId_type: z.lazy(() => ReferralEdgeChildIdTypeCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["childId","type"]] as string[][];
...
export const ReferralEdgeWhereUniqueInputObjectSchema: z.ZodType<Prisma.ReferralEdgeWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.ReferralEdgeWhereUniqueInput>;
export const ReferralEdgeWhereUniqueInputObjectZodSchema = makeSchema();
