...
export const ApiAuditLogFindFirstSelectSchema: z.ZodType<Prisma.ApiAuditLogSelect> = z.object({
...
export const ApiAuditLogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    path: z.boolean().optional(),
    method: z.boolean().optional(),
...
export const ApiAuditLogFindFirstSchema: z.ZodType<Prisma.ApiAuditLogFindFirstArgs> = z.object({ select: ApiAuditLogFindFirstSelectSchema.optional(),  orderBy: z.union([ApiAuditLogOrderByWithRelationInputObjectSchema, ApiAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApiAuditLogWhereInputObjectSchema.optional(), cursor: ApiAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApiAuditLogScalarFieldEnumSchema, ApiAuditLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ApiAuditLogFindFirstArgs>;

export const ApiAuditLogFindFirstZodSchema = z.object({ select: ApiAuditLogFindFirstSelectSchema.optional(),  orderBy: z.union([ApiAuditLogOrderByWithRelationInputObjectSchema, ApiAuditLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: ApiAuditLogWhereInputObjectSchema.optional(), cursor: ApiAuditLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ApiAuditLogScalarFieldEnumSchema, ApiAuditLogScalarFieldEnumSchema.array()]).optional() }).strict();