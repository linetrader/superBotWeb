...
export const StrategyConfigFindFirstSelectSchema: z.ZodType<Prisma.StrategyConfigSelect> = z.object({
...
export const StrategyConfigFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const StrategyConfigFindFirstSchema: z.ZodType<Prisma.StrategyConfigFindFirstArgs> = z.object({ select: StrategyConfigFindFirstSelectSchema.optional(), include: z.lazy(() => StrategyConfigIncludeObjectSchema.optional()), orderBy: z.union([StrategyConfigOrderByWithRelationInputObjectSchema, StrategyConfigOrderByWithRelationInputObjectSchema.array()]).optional(), where: StrategyConfigWhereInputObjectSchema.optional(), cursor: StrategyConfigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StrategyConfigScalarFieldEnumSchema, StrategyConfigScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StrategyConfigFindFirstArgs>;

export const StrategyConfigFindFirstZodSchema = z.object({ select: StrategyConfigFindFirstSelectSchema.optional(), include: z.lazy(() => StrategyConfigIncludeObjectSchema.optional()), orderBy: z.union([StrategyConfigOrderByWithRelationInputObjectSchema, StrategyConfigOrderByWithRelationInputObjectSchema.array()]).optional(), where: StrategyConfigWhereInputObjectSchema.optional(), cursor: StrategyConfigWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StrategyConfigScalarFieldEnumSchema, StrategyConfigScalarFieldEnumSchema.array()]).optional() }).strict();