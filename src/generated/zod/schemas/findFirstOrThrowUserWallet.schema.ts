...
export const UserWalletFindFirstOrThrowSelectSchema: z.ZodType<Prisma.UserWalletSelect> = z.object({
...
export const UserWalletFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    user: z.boolean().optional(),
    depositAddress: z.boolean().optional(),
