...
export const BotRuntimeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BotRuntimeSelect> = z.object({
...
export const BotRuntimeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    botId: z.boolean().optional(),
    bot: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const BotRuntimeFindFirstOrThrowSchema: z.ZodType<Prisma.BotRuntimeFindFirstOrThrowArgs> = z.object({ select: BotRuntimeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BotRuntimeIncludeObjectSchema.optional()), orderBy: z.union([BotRuntimeOrderByWithRelationInputObjectSchema, BotRuntimeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotRuntimeWhereInputObjectSchema.optional(), cursor: BotRuntimeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotRuntimeScalarFieldEnumSchema, BotRuntimeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BotRuntimeFindFirstOrThrowArgs>;

export const BotRuntimeFindFirstOrThrowZodSchema = z.object({ select: BotRuntimeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BotRuntimeIncludeObjectSchema.optional()), orderBy: z.union([BotRuntimeOrderByWithRelationInputObjectSchema, BotRuntimeOrderByWithRelationInputObjectSchema.array()]).optional(), where: BotRuntimeWhereInputObjectSchema.optional(), cursor: BotRuntimeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BotRuntimeScalarFieldEnumSchema, BotRuntimeScalarFieldEnumSchema.array()]).optional() }).strict();